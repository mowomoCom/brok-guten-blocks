...
const run = async () => {
    fs.readFile("./" + ficheroPHP, "utf8", function(err, contents) {
        ...
        if (arguments.length == 3) {
            ...
            if (
                blocks.indexOf(nombreBloque) == -1 &&
                nombreBloque.length <= 30
            ) {
                // Añadimos el bloque
                ...
                if (
                    ...
                    fs.readFile("./src/index.js", "utf8", function(
                        err2,
                        contents2
                    ) {
                        ...
                        blocks.forEach(element => {
                            ...
                            newJSDocument +=
                                "import './" + newElement + "/block';\n";
                        });

                        // Tratamos de escribir el fichero
                        if (
                            functions.writeFile("./src/index.js", newJSDocument)
                        ) {
                    ...
                    console.log(
                        "> ERROR: No se ha podido modificar el fichero '" +
                            ficheroPHP +
                            "'"
                    );
                }
